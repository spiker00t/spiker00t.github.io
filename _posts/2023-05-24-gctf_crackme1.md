---
title: (Reverse - Grey Cat The Flag 2023 Quals) Crackme1
published: true
---

![chall](assets/crackme1/img/chall.png)
...
![packets](assets/crackme1/img/webpage.png)
...
![obfu_js](assets/crackme1/img/obfu_js.png)
...
This function take as argument an index `i`, and returns the string at index `i-0x171` in the large array. That's how most of the strings of the program are retrieved. We can then replace all the calls to this function with the corresponding string. I've done it by hand, by calling manually the function `_0xb32e` in the JavaScript console. You can find the resulting script [there](https://github.com/spiker00t/ctf-writeups/blob/main/2023/greyCatTheFlag/crackme1/src/app_deobf1.js).
...
For more details, you can find the final deobfuscated JS script [here](https://github.com/spiker00t/ctf-writeups/blob/main/2023/greyCatTheFlag/crackme1/src/app_deobf2.js).
...
The algorithm can be simplified and written in Python as follows (see full script [here](https://github.com/spiker00t/ctf-writeups/blob/main/2023/greyCatTheFlag/crackme1/src/check_flag.py)):
...
During the CTF, I was lazy so I retrieved one by one the characters of the key in the same way, but here is a nice script to get the key (full script [here](https://github.com/spiker00t/ctf-writeups/blob/main/2023/greyCatTheFlag/crackme1/src/solve.py)):
...
![good_cat](assets/crackme1/img/good_cat.png)
