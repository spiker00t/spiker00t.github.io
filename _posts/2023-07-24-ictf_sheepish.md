---
title: (Reverse - imaginaryCTF 2023) Sheepish
published: true
---

![challenge](assets/sheepish/img/chall.png)
...
We are given a Python script, consisting in a single line of ~26k characters, with lots of lambda-functions. The full script is available [here](https://github.com/spiker00t/ctf-writeups/blob/main/2023/imaginaryCTF/sheepish/src/sheepish.py)
...
The script is now way shorter, and a bit understandable (see [here](https://github.com/spiker00t/ctf-writeups/blob/main/2023/imaginaryCTF/sheepish/src/sheepish_deobf2.py)). We can recognize a sequence of arithmetic expressions, such as:
...
To solve the chall, I took the expressions, and I reimplemented the operators (full script [here](https://github.com/spiker00t/ctf-writeups/blob/main/2023/imaginaryCTF/sheepish/src/sheepish_arith.py)):
