---
title: (Reverse - FCSC 2024) PTSD (both parts)
published: true
---
...
[here](https://github.com/spiker00t/ctf-writeups/blob/main/2024/fcsc/ptsd/src/exploit_part1.py). The functions `send_msg` and `recv_msg`
...
The second part of the script (full script available [here](https://github.com/spiker00t/ctf-writeups/blob/main/2024/fcsc/ptsd/src/exploit_part2.py)):
```python
